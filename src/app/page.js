  ...
  return (
    <section id="hero">
      ...
      <div className={`hero-form${isFormOpen ? ' open' : ' closed'}`}>
        ...
        <a href="https://wa.me/919823999414?text=Hi%20AR%20Interiors,%20I'm%20interested%20in%20a%20free%20design%20consultation." className="btn btn-wa" target="_blank" rel="noopener noreferrer" style={{ width: '100%', justifyContent: 'center' }}>
